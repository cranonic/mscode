...
export interface GitChangedFile {
  /** Absolute or workspace path to the file/directory. */
  path:     string;
  ...
  oldPath?: string;
  /**
   * True when this entry is a directory (e.g. untracked folder from
   * `git status` without `-uall`). Must not open a file diff.
   */
  isDirectory?: boolean;
}
