...
public final class PkgShellFragment {
    ...
    public static void append(StringBuilder sb) {
        ...
        sb.append("    elf \"$PREFIX/bin/ar\" x \"$_ar_file\" && return 0\n");
        sb.append("  fi\n");
        sb.append("  # Pure System V ar reader — headers written to temp files (no newline strip)\n");
        sb.append("  _hdrf=\".ar_hdr_$$\"; _namef=\".ar_name_$$\"; _szf=\".ar_sz_$$\"\n");
        sb.append("  dd if=\"$_ar_file\" of=\"$_hdrf\" bs=8 count=1 2>/dev/null || return 1\n");
        sb.append("  _magic=$(dd if=\"$_hdrf\" bs=8 count=1 2>/dev/null; printf x)\n");
        sb.append("  _magic=${_magic%x}\n");
        sb.append("  case \"$_magic\" in\n");
        sb.append("    '!<arch>'|'!<arch>\\n') ;;\n");
        sb.append("    *) echo \"[pkg] not an ar archive: $_ar_file\" >&2; rm -f \"$_hdrf\"; return 1 ;;\n");
        sb.append("  esac\n");
        sb.append("  _off=8\n");
